...
const month = parseInt(req.body.month); // Assuming you are using Express and retrieving month from the form
const year = parseInt(req.body.year); // Assuming you are using Express and retrieving year from the form

// Retrieve all vehicles from the database
const vehicles = await Vehicle.find();

// Filter vehicles by month and year
...
// Now filteredVehicles contains the vehicles issued in the specified month and year
    ...
    const html = ejs.render(templateContent, { filteredVehicles: filteredVehicles });
    try {
